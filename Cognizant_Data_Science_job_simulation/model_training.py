...
import pandas as pd #handle dataframe processing
...
def main():
    ...
    X, y = create_target_and_predictors(data=df) #define target (y) and predictor (X)
    train_algorithm_with_cross_validation(X=X, y=y) #train model with RandomForest algorithm and perform cross-validation
